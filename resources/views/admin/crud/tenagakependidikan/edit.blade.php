...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
        <div>
            <h4 class="fw-bold mb-1">Edit Tenaga Kependidikan</h4>
            <p class="text-muted mb-0">Perbarui data tenaga kependidikan</p>
        </div>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-5">
                    ...
                    {{-- FORM --}}
                    <form action="{{ route('admin.tenaga.update', $tenaga->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-3">
                                @if($tenaga->foto)
                                    <img id="fotoPreview" src="{{ asset('storage/' . $tenaga->foto) }}" alt="Current Photo" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
                                @else
...
document.getElementById('foto').addEventListener('change', function(e) {
    ...
    if (file) {
        ...
        // Jika tidak ada file baru, kembalikan ke foto asli
        @if($tenaga->foto)
            preview.src = "{{ asset('storage/' . $tenaga->foto) }}";
            preview.classList.remove('d-none');
        @else
