...
@section('content')
    ...
    <div class="container-fluid">
                ...
                <div class="stat-card slide-in" style="animation-delay: 0.1s;">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="fw-bold mb-0">{{ $galeri->where('created_at', '>=', now()->subMonth())->count() }}
                            </h2>
                        </div>
        ...
        <div class="gallery-grid" id="galeriContainer">
            @forelse ($galeri as $g)
                <div class="galeri-item slide-in" data-judul="{{ strtolower($g->judul) }}" data-date="{{ $g->created_at }}"
                    style="animation-delay: 0.{{ 4 + $loop->index * 0.05 }}s;">
            ...
            @empty
                <!-- EMPTY STATE -->
                <div class="col-12">
                    <div class="empty-state slide-in" style="animation-delay: 0.4s;">
