        ...
        <div class="popup-body">
            ...
            <form action="{{ route('admin.users.update', $user) }}" method="POST" id="userForm">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="name" name="name" class="form-control" value="{{ old('name', $user->name) }}" placeholder="Masukkan nama lengkap" required>
                </div>

                {{-- EMAIL --}}
                <div class="mb-3">
                    <label for="email" class="form-label">Alamat Email</label>
                    <input type="email" id="email" name="email" class="form-control" value="{{ old('email', $user->email) }}" placeholder="email@example.com" required>
                </div>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary">
                        ...
                        <span class="btn-text"><i class="bi bi-arrow-clockwise"></i> Perbarui Data</span>
                    </button>
                </div>
