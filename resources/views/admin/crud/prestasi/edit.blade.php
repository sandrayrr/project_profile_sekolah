    ...
    <div class="popup-card">
        ...
        <div class="popup-body">
            ...
            <form action="{{ route('admin.prestasi.update',$prestasi->id) }}"
                ...
                {{-- KELAS --}}
                <div class="mb-3">
                    <label for="kelas" class="form-label">Peraih Prestasi (Kelas/Nama)</label>
                    <input type="text"
                           id="kelas"
                           name="kelas"
                           class="form-control @error('kelas') is-invalid @enderror"
                           value="{{ old('kelas', $prestasi->kelas) }}"
                           placeholder="Contoh: XII RPL 2 atau Ahmad Budiman"
                           required>
                    @error('kelas')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="d-flex justify-content-end gap-2">
                    <a href="{{ route('admin.prestasi.index') }}" class="btn btn-light">
                        Batal
                    </a>
                    <button type="submit" class="btn btn-primary">
                        <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                        <span class="btn-text"><i class="bi bi-arrow-clockwise me-1"></i> Perbarui Prestasi</span>
                    </button>
                </div>
...
<script>
    document.getElementById('prestasiForm').addEventListener('submit', function() {
