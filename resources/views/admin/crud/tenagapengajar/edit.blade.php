...
<div class="popup-container">
    <div class="popup-card">
        ...
        <div class="popup-header">
            ...
            <a href="{{ route('admin.tenagapengajar.index') }}" class="popup-close" title="Tutup">&times;</a>
        </div>
        ...
        <div class="popup-body">
            ...
            <form action="{{ route('admin.tenagapengajar.update', $tenaga->id) }}"
                  method="POST"
                ...
                {{-- PENGAMPU --}}
                <div class="mb-3">
                    <label for="pengampu" class="form-label">Mata Pelajaran / Jabatan</label>
                    <input type="text"
                           id="pengampu"
                           name="pengampu"
                           class="form-control @error('pengampu') is-invalid @enderror"
                           value="{{ old('pengampu', $tenaga->pengampu) }}"
                ...
                <div class="d-flex justify-content-end gap-2">
                    <a href="{{ route('admin.tenagapengajar.index') }}" class="btn btn-light">
                        Batal
                    </a>
                    <button type="submit" class="btn btn-primary">
                        <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                        <span class="btn-text"><i class="bi bi-arrow-clockwise me-1"></i> Perbarui Data</span>
                    </button>
                </div>
...
<script>
    document.getElementById('tenagaForm').addEventListener('submit', function() {
