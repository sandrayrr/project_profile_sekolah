...
/* Gaya untuk TinyMCE agar selaras */
.tox-tinymce {
...
<div class="popup-container">
    <div class="popup-card">
        ...
        <div class="popup-header">
            ...
            <a href="{{ route('admin.artikel.index') }}" class="popup-close" title="Tutup">&times;</a>
        </div>
            ...
            <form action="{{ route('admin.artikel.update', $artikel->id) }}"
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary">
                        ...
                        <span class="btn-text"><i class="bi bi-arrow-clockwise me-1"></i> Perbarui Artikel</span>
                    </button>
                </div>
            </form>
        </div>
...
@push('scripts')
<!-- Pastikan Anda sudah memiliki Bootstrap JS -->
<script src="https://cdn.tiny.cloud/1/no-api-key/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
<script>
    // Inisialisasi TinyMCE
    tinymce.init({
        selector: '#deskripsi',
        height: 350, // TINGGI EDITOR DIPERKECIL
    ...
    document.getElementById('artikelForm').addEventListener('submit', function(e) {
        // Trigger TinyMCE untuk menyimpan konten ke textarea sebelum submit
        tinymce.triggerSave();
