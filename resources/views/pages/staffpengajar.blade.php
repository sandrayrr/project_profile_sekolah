...
<h3 class="font-bold text-lg text-gray-900 dark:text-white mb-1 group-hover:text-primary transition-colors">Drs. H. Budi Santoso</h3>
<p class="text-sm text-gray-500 dark:text-gray-400">Bahasa Indonesia</p>
</div>
</div>
<div class="bg-white dark:bg-surface-dark rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300 border border-border-light dark:border-border-dark group">
<div class="bg-gray-200 dark:bg-gray-700 h-64 w-full flex items-center justify-center relative overflow-hidden">
...
<div class="p-5 text-center">
<h3 class="font-bold text-lg text-gray-900 dark:text-white mb-1 group-hover:text-primary transition-colors">Siti Aminah, S.Pd</h3>
<p class="text-sm text-gray-500 dark:text-gray-400">Matematika</p>
</div>
</div>
<div class="bg-white dark:bg-surface-dark rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300 border border-border-light dark:border-border-dark group">
<div class="bg-gray-200 dark:bg-gray-700 h-64 w-full flex items-center justify-center relative overflow-hidden">
...
<div class="p-5 text-center">
<h3 class="font-bold text-lg text-gray-900 dark:text-white mb-1 group-hover:text-primary transition-colors">Rahmat Hidayat, M.Kom</h3>
<p class="text-sm text-gray-500 dark:text-gray-400">Teknik Komputer &amp; Jaringan</p>
</div>
</div>
<div class="bg-white dark:bg-surface-dark rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300 border border-border-light dark:border-border-dark group">
<div class="bg-gray-200 dark:bg-gray-700 h-64 w-full flex items-center justify-center relative overflow-hidden">
...
<div class="p-5 text-center">
<h3 class="font-bold text-lg text-gray-900 dark:text-white mb-1 group-hover:text-primary transition-colors">Dewi Sartika, S.Pd</h3>
<p class="text-sm text-gray-500 dark:text-gray-400">Bahasa Inggris</p>
</div>
</div>
<div class="bg-white dark:bg-surface-dark rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300 border border-border-light dark:border-border-dark group">
<div class="bg-gray-200 dark:bg-gray-700 h-64 w-full flex items-center justify-center relative overflow-hidden">
...
<div class="p-5 text-center">
<h3 class="font-bold text-lg text-gray-900 dark:text-white mb-1 group-hover:text-primary transition-colors">Ahmad Fauzi, S.T</h3>
<p class="text-sm text-gray-500 dark:text-gray-400">Teknik Kendaraan Ringan</p>
</div>
</div>
<div class="bg-white dark:bg-surface-dark rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300 border border-border-light dark:border-border-dark group">
<div class="bg-gray-200 dark:bg-gray-700 h-64 w-full flex items-center justify-center relative overflow-hidden">
...
<div class="p-5 text-center">
<h3 class="font-bold text-lg text-gray-900 dark:text-white mb-1 group-hover:text-primary transition-colors">Linda Kusuma, S.Pd</h3>
<p class="text-sm text-gray-500 dark:text-gray-400">Seni Budaya</p>
</div>
</div>
<div class="bg-white dark:bg-surface-dark rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300 border border-border-light dark:border-border-dark group">
<div class="bg-gray-200 dark:bg-gray-700 h-64 w-full flex items-center justify-center relative overflow-hidden">
...
<div class="p-5 text-center">
<h3 class="font-bold text-lg text-gray-900 dark:text-white mb-1 group-hover:text-primary transition-colors">Ir. Bambang Wijaya</h3>
<p class="text-sm text-gray-500 dark:text-gray-400">Fisika</p>
</div>
</div>
<div class="bg-white dark:bg-surface-dark rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300 border border-border-light dark:border-border-dark group">
<div class="bg-gray-200 dark:bg-gray-700 h-64 w-full flex items-center justify-center relative overflow-hidden">
...
<div class="p-5 text-center">
<h3 class="font-bold text-lg text-gray-900 dark:text-white mb-1 group-hover:text-primary transition-colors">Nurul Hidayati, S.Ag</h3>
<p class="text-sm text-gray-500 dark:text-gray-400">Pendidikan Agama Islam</p>
</div>
</div>
</div>
...
<span class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 border-t border-b border-r border-gray-300 dark:border-gray-600">
                    ...
                </span>
