        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 group">
                ...
                <div class="h-24 bg-gray-200 dark:bg-gray-600 p-6 flex flex-col justify-center">
                    <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-200">{{ $item->judul }}</h3>
                </div>
            </div>
            @empty
            <div class="col-span-full text-center py-12">
                <p class="text-gray-500 dark:text-gray-400">Belum ada data fasilitas yang tersedia.</p>
            </div>
            @endforelse
        </div>
    </main>
