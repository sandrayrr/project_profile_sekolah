...
<body
    class="bg-background-light bg-background-dark text-gray-800 text-gray-100 transition-colors duration-200">
    @include('layouts.navbar')
    <main class="container mx-auto px-4 py-10 max-w-6xl">
        <div class="mb-8">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 text-white">Profil Sekolah</h2>
            <div class="w-20 h-1 bg-primary mt-2 rounded-full"></div>
        </div>
        <div
            class="w-full h-[400px] bg-gray-200 bg-gray-700 rounded-2xl flex items-center justify-center mb-12 shadow-sm overflow-hidden relative group">
            <div class="text-center z-10">
                <i class="fas fa-image text-6xl text-gray-400 text-gray-500 mb-4"></i>
                <p class="text-2xl font-medium text-gray-500 text-gray-400">Foto Utama Sekolah</p>
            </div>
            <img alt="Gedung Sekolah"
                class="absolute inset-0 w-full h-full object-cover opacity-50 opacity-40 group-hover:opacity-60 transition-opacity duration-300"
        ...
        <div class="max-w-4xl mx-auto text-center mb-16">
            <h3 class="text-2xl font-semibold mb-6 text-gray-800 text-gray-100">Deskripsi</h3>
            <div class="prose prose-lg prose-invert mx-auto text-gray-600 text-gray-300">
                <p>
        ...
        <div class="grid md:grid-cols-2 gap-8 mb-16">
            <div
                class="bg-gray-200 bg-surface-dark p-10 rounded-2xl shadow-sm text-center flex flex-col items-center justify-center min-h-[400px]">
                <div
                    class="w-16 h-16 bg-white bg-gray-700 rounded-full flex items-center justify-center mb-6 shadow-md">
                    <i class="fas fa-eye text-2xl text-primary"></i>
                </div>
                <h3 class="text-3xl font-bold mb-6 text-gray-900 text-white uppercase tracking-wider">Visi</h3>
                <p class="text-gray-600 text-gray-300 max-w-sm">
            ...
            <div
                ...
                <h3 class="text-3xl font-bold mb-6 text-gray-900 text-white uppercase tracking-wider">Misi</h3>
                <ul class="text-gray-600 text-gray-300 text-left list-disc pl-5 space-y-2 max-w-sm mx-auto">
        ...
        <div class="bg-gray-200 bg-surface-dark rounded-3xl p-8 md:p-12 mb-16">
            <h3 class="text-center text-xl font-bold mb-10 text-gray-800 text-gray-100 uppercase tracking-widest">
                Agenda Mendatang</h3>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="flex flex-col items-center text-center">
                    <div
                        class="w-32 h-32 bg-white bg-gray-700 rounded-full mb-4 flex items-center justify-center shadow-md overflow-hidden hover:scale-105 transition-transform duration-300">
                    ...
                    <p class="text-sm font-semibold text-primary text-blue-400">2 Januari 2025</p>
                    <p class="text-gray-800 text-gray-200 font-medium">Pembukaan SMK</p>
                </div>
                <div class="flex flex-col items-center text-center">
                    <div
                        class="w-32 h-32 bg-white bg-gray-700 rounded-full mb-4 flex items-center justify-center shadow-md overflow-hidden hover:scale-105 transition-transform duration-300">
                    ...
                    <p class="text-sm font-semibold text-primary text-blue-400">15 Februari 2025</p>
                    <p class="text-gray-800 text-gray-200 font-medium">Uji Kompetensi</p>
                </div>
                <div class="flex flex-col items-center text-center">
                    <div
                        class="w-32 h-32 bg-white bg-gray-700 rounded-full mb-4 flex items-center justify-center shadow-md overflow-hidden hover:scale-105 transition-transform duration-300">
                    ...
                    <p class="text-sm font-semibold text-primary text-blue-400">20 Maret 2025</p>
                    <p class="text-gray-800 text-gray-200 font-medium">Kunjungan Industri</p>
                </div>
                <div class="flex flex-col items-center text-center">
                    <div
                        class="w-32 h-32 bg-white bg-gray-700 rounded-full mb-4 flex items-center justify-center shadow-md overflow-hidden hover:scale-105 transition-transform duration-300">
                    ...
                    <p class="text-sm font-semibold text-primary text-blue-400">10 April 2025</p>
                    <p class="text-gray-800 text-gray-200 font-medium">Pentas Seni</p>
                </div>
                <div class="flex flex-col items-center text-center">
                    <div
                        class="w-32 h-32 bg-white bg-gray-700 rounded-full mb-4 flex items-center justify-center shadow-md overflow-hidden hover:scale-105 transition-transform duration-300">
                    ...
                    <p class="text-sm font-semibold text-primary text-blue-400">2 Mei 2025</p>
                    <p class="text-gray-800 text-gray-200 font-medium">Hari Pendidikan</p>
                </div>
                <div class="flex flex-col items-center text-center">
                    <div
                        class="w-32 h-32 bg-white bg-gray-700 rounded-full mb-4 flex items-center justify-center shadow-md overflow-hidden hover:scale-105 transition-transform duration-300">
                    ...
                    <p class="text-sm font-semibold text-primary text-blue-400">17 Juni 2025</p>
                    <p class="text-gray-800 text-gray-200 font-medium">Wisuda Angkatan 20</p>
                </div>
                <div class="flex flex-col items-center text-center">
                    <div
                        class="w-32 h-32 bg-white bg-gray-700 rounded-full mb-4 flex items-center justify-center shadow-md overflow-hidden hover:scale-105 transition-transform duration-300">
                    ...
                    <p class="text-sm font-semibold text-primary text-blue-400">15 Juli 2025</p>
                    <p class="text-gray-800 text-gray-200 font-medium">MPLS Siswa Baru</p>
                </div>
                <div class="flex flex-col items-center text-center">
                    <div
                        class="w-32 h-32 bg-white bg-gray-700 rounded-full mb-4 flex items-center justify-center shadow-md overflow-hidden hover:scale-105 transition-transform duration-300">
                    ...
                    <p class="text-sm font-semibold text-primary text-blue-400">17 Agustus 2025</p>
                    <p class="text-gray-800 text-gray-200 font-medium">Upacara Kemerdekaan</p>
                </div>
            </div>
        </div>
    </main>
