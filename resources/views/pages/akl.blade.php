...
<body class="bg-background-light dark:bg-background-dark text-gray-800 dark:text-gray-100 font-body">
    ...
    <!-- HEADER JURUSAN -->
    <header class="bg-gradient-to-b from-green-50 to-green-100 dark:from-gray-900 dark:to-gray-800 py-16 md:py-24">
        <div class="container mx-auto px-4 text-center">
            <!-- Button -->
            <div class="mb-6">
                <button
                    class="px-6 py-2 bg-white dark:bg-gray-800 text-primary font-semibold rounded-full shadow-md hover:shadow-lg transition-shadow duration-300 border border-green-200 dark:border-gray-700">
            ...
            <h1 class="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">
                Jurusan <span class="text-primary">AKL</span>
            </h1>

            <!-- Description -->
            <p class="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8">
                Informasi Jurusan Akuntansi Keuangan Lembaga SMK Negeri 1 Kawali.
            </p>
                ...
                <div id="identitas" class="tab-pane">
                    <div class="bg-card-light dark:bg-card-dark rounded-2xl shadow-lg p-8">
                        <h3 class="text-2xl font-bold mb-6 text-gray-900 dark:text-white text-center relative">
                            <span
                                class="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Identitas
                                Jurusan</span>
                            <div
                                class="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-24 h-1 bg-gradient-to-r from-primary to-secondary rounded-full">
                            </div>
                        </h3>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border-l-4 border-primary shadow-sm">
                                <p class="text-gray-700 dark:text-gray-300 leading-relaxed">
                                    Akuntansi Keuangan Lembaga adalah Kompetensi Kejuruan yang memiliki pengetahuan,
                                    keterampilan dan nilai serta sikap yang terintegrasi dan kecakapan kerja dalam
                                    bidang Akuntansi dengan menerapkan kewiraswastaan serta mampu mengadaptasi
                                    perkembangan masyarakat yang sesuai dengan kemajuan ilmu dan teknologi serta dapat
                                    memenuhi tuntutan dunia kerja masa sekarang dan masa yang akan datang.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-center">
                            <div class="max-w-2xl w-full">
                                <h4
                                    class="text-lg font-semibold mb-6 text-gray-900 dark:text-white text-center flex items-center justify-center">
                                    <span
                                        class="w-8 h-8 bg-primary bg-opacity-10 rounded-lg flex items-center justify-center mr-3">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div
                                        class="bg-white dark:bg-gray-800 rounded-xl p-5 shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 hover:-translate-y-1">
                                        <div class="flex flex-col items-center text-center">
                                            <div
                                                class="w-14 h-14 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900 dark:to-green-800 rounded-full flex items-center justify-center mb-3">
                                            ...
                                            <p class="text-gray-600 dark:text-gray-400 text-sm">Akuntansi dan Keuangan
                                                Lembaga</p>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div class="flex flex-col items-center text-center">
                                            ...
                                            <h5 class="font-medium text-gray-900 dark:text-white mb-1">Kepala Jurusan
                                            </h5>
                                            <p class="text-gray-600 dark:text-gray-400 text-sm">Ibu Siti Nurhaliza,
                                                S.E., M.Ak.</p>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div class="flex flex-col items-center text-center">
                                            ...
                                            <h5 class="font-medium text-gray-900 dark:text-white mb-1">Mitra Industri
                                            </h5>
                                            <p class="text-gray-600 dark:text-gray-400 text-sm">KAP, KPP, Bank,
                                                Perusahaan Manufaktur</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-card-light dark:bg-card-dark rounded-2xl shadow-lg p-8">
                        ...
                        <div class="grid md:grid-cols-3 gap-6 mb-8">
                            <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
                                <h4 class="font-semibold text-gray-900 dark:text-white mb-4">Guru Dasar Dasar Program
                                    Keahlian</h4>
                                <div class="space-y-3">
                                    <div class="bg-white dark:bg-gray-700 p-3 rounded-lg">
                                        <p class="font-medium text-gray-900 dark:text-white">Eni Kusnaeni, S.Pd., M.M
                                        </p>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
                                <h4 class="font-semibold text-gray-900 dark:text-white mb-4">Guru Akuntansi dan Keuangan
                                    Lembaga</h4>
                                <div class="space-y-3">
                                    <div class="bg-white dark:bg-gray-700 p-3 rounded-lg">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
                                <h4 class="font-semibold text-gray-900 dark:text-white mb-4">Guru Mata Pelajaran Pilihan
                                </h4>
                                <div class="space-y-3">
                                    <div class="bg-white dark:bg-gray-700 p-3 rounded-lg">
                        ...
                        <div class="grid md:grid-cols-3 gap-6">
                            <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
                                ...
                                <div class="grid grid-cols-1 gap-3">
                                    <div class="bg-white dark:bg-gray-700 p-3 rounded-lg">
                                        <span class="text-gray-700 dark:text-gray-300">Wali Kelas X AKL 1 : Eni
                                            Kusnaeni, S.Pd., M.M</span>
                                    </div>
                                    <div class="bg-white dark:bg-gray-700 p-3 rounded-lg">
                                        <span class="text-gray-700 dark:text-gray-300">Wali Kelas X AKL 2 : Yani
                                            Handayani, S.Pd</span>
                                    </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
                                ...
                                <div class="grid grid-cols-1 gap-3">
                                    <div class="bg-white dark:bg-gray-700 p-3 rounded-lg">
                                        <span class="text-gray-700 dark:text-gray-300">Wali Kelas XI AKL 1 : Ika
                                            Riskawati, S.Pd.</span>
                                    </div>
                                    <div class="bg-white dark:bg-gray-700 p-3 rounded-lg">
                                        <span class="text-gray-700 dark:text-gray-300">Wali Kelas XI AKL 2 : Ade
                                            Nuraisah, S.Pd</span>
                                    </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
                                ...
                                <div class="grid grid-cols-1 gap-3">
                                    <div class="bg-white dark:bg-gray-700 p-3 rounded-lg">
                                        <span class="text-gray-700 dark:text-gray-300">Wali Kelas XII AKL 1 : Tuti
                                            Fitriyah S.Pd</span>
                                    </div>
                                    <div class="bg-white dark:bg-gray-700 p-3 rounded-lg">
                                        <span class="text-gray-700 dark:text-gray-300">Wali Kelas XII AK 2 : Neni
                                            Nuraeni, S.Pd</span>
                                    </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <div class="grid md:grid-cols-2 gap-3">
                                        <div class="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg">
                                            <p class="text-sm text-gray-700 dark:text-gray-300">• Memahami Etika Profesi
                                                dan Budaya Kerja Akuntansi</p>
                                        </div>
                                        <div class="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg">
                                            <p class="text-sm text-gray-700 dark:text-gray-300">• Memahami Aplikasi
                                                Pengolah Angka (Spreadsheet)
                                            </p>
                                        </div>
                                        <div class="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg">
                                            <p class="text-sm text-gray-700 dark:text-gray-300">•Memahami Akuntansi
                                                Dasar
                                            </p>
                                        </div>
                                        <div class="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg">
                                            <p class="text-sm text-gray-700 dark:text-gray-300">•Memahami Perbankan
                                                Dasar
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="grid md:grid-cols-2 gap-3">
                                        <div class="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg">
                                            <p class="text-sm text-gray-700 dark:text-gray-300">•Menerapkan Akuntansi
                                        ...
                                        <div class="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg">
                                            <p class="text-sm text-gray-700 dark:text-gray-300">•Menerapkan Komputer
                                                Akuntansi
                                            </p>
                                        </div>
                                        <div class="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <div class="grid md:grid-cols-2 gap-3">
                                        <div class="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg">
                                            <p class="text-sm text-gray-700 dark:text-gray-300">•Menerapkan Akuntansi
                                                Perusahaan Jasa, Dagang, dan Manufaktur secara Lanjutan</p>
                                        </div>
                                        <div class="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg">
                                            <p class="text-sm text-gray-700 dark:text-gray-300">• Menerapkan Akuntansi
                                                Lembaga/Instansi secara Profesional
                                            </p>
                                        </div>
                                        <div class="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg">
                                            <p class="text-sm text-gray-700 dark:text-gray-300">•Menerapkan Penyusunan
                                                Laporan Keuangan</p>
                                        </div>
                                        <div class="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg">
                                            <p class="text-sm text-gray-700 dark:text-gray-300">• Menerapkan
                                                Administrasi Perpajakan sesuai Ketentuan</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <div class="bg-gray-50 dark:bg-gray-700 rounded-xl p-6 card-hover">
                    <div class="flex items-center mb-4">
                        <img src="Ak9.jpeg" alt="Alumni" class="w-12 h-12 rounded-full mr-4">
                        <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-sm italic">"Bersekolah di jurusan Akuntansi SMKN 1
                        Kawali memberikan saya banyak pengalaman berharga, tidak hanya dalam memahami pencatatan
                        keuangan dan laporan akuntansi, tetapi juga dalam melatih ketelitian, tanggung jawab, dan
                        disiplin. Didukung oleh guru-guru yang kompeten serta lingkungan belajar yang nyaman, saya
                        merasa dibimbing untuk siap menghadapi dunia kerja maupun melanjutkan pendidikan ke jenjang yang
                        lebih tinggi. Jurusan Akuntansi di SMKN 1 Kawali menjadi fondasi penting bagi saya dalam
                        membangun keterampilan profesional dan kepercayaan diri untuk masa depan."</p>
                </div>
                <div class="bg-gray-50 dark:bg-gray-700 rounded-xl p-6 card-hover">
                    <div class="flex items-center mb-4">
                        <img src="dzikri.jpeg" alt="Alumni" class="w-12 h-12 rounded-full mr-4">
                        <div>
                ...
                <div class="bg-gray-50 dark:bg-gray-700 rounded-xl p-6 card-hover">
                    <div class="flex items-center mb-4">
                        ...
                        <div>
                            <h4 class="font-semibold text-gray-900 dark:text-white">Maya Aulia</h4>
                            <p class="text-sm text-gray-600 dark:text-gray-400">PT. Paragon</p>
                        </div>
                    </div>
                    <p class="text-gray-700 dark:text-gray-300 text-sm mb-3">Alumni 2022</p>
                    <p class="text-gray-600 dark:text-gray-400 text-sm italic">"Jurusan AKL membekali saya dengan ilmu akuntansi yang aplikatif dan relevan dengan dunia kerja. Selain keterampilan teknis, saya juga dilatih untuk bekerja dengan rapi, konsisten, dan memiliki etos kerja yang baik."</p>
                </div>
            </div>
        </div>
    </section>
