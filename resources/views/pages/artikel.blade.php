...
=======
<body
    class="bg-background-light bg-background-dark text-text-light text-text-dark font-sans transition-colors duration-200">
...
<div class="lg:col-span-2">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div
            class="bg-card-light bg-card-dark rounded-xl shadow-sm border border-border-light border-border-dark overflow-hidden hover:shadow-md transition-shadow">

            <!-- FOTO -->
            <div class="h-48 bg-gray-200 bg-gray-700 relative overflow-hidden">
                @if ($item->foto)
                    <img
            ...
            <div class="p-5">
                ...
                <h3
                    class="text-lg font-bold text-gray-900 text-white mb-2 leading-snug hover:text-primary transition-colors">
                    {{ $item->judul }}
                </h3>

                <p class="text-gray-500 text-gray-400 text-sm line-clamp-3">
                    {{ $item->deskripsi }}
                </p>
            </div>
>>>>>>> Stashed changes
...
=======
                ...
                <div class="mt-8 flex justify-center">
                    <nav aria-label="Pagination" class="isolate inline-flex -space-x-px rounded-md shadow-sm">
                        <a class="relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0 ring-gray-600 hover:bg-gray-700"
                            href="#">
                        ...
                        <a aria-current="page"
                            ...
                            href="#">1</a>
                        <a class="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0 text-gray-200 ring-gray-600 hover:bg-gray-700"
                            href="#">2</a>
                        <a class="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0 text-gray-200 ring-gray-600 hover:bg-gray-700"
                            href="#">3</a>
                        <a class="relative inline-flex items-center rounded-r-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0 ring-gray-600 hover:bg-gray-700"
                            href="#">
...
>>>>>>> Stashed changes
            ...
            <aside class="space-y-8">
                <div
                    class="bg-gray-50 bg-card-dark rounded-xl p-6 shadow-sm border border-border-light border-border-dark">
                    <h3
                        class="text-lg font-bold text-gray-900 text-white mb-4 pb-2 border-b border-gray-200 border-gray-700">
                        Kategori Artikel
                    </h3>
                    <ul class="space-y-3">
                        <li>
                            <a class="flex justify-between items-center text-gray-600 text-gray-300 hover:text-primary hover:text-primary transition-colors group"
                                href="#">
                                <span>Akademik</span>
                                <span
                                    class="bg-gray-200 bg-gray-700 text-gray-600 text-gray-400 text-xs px-2 py-1 rounded-full group-hover:bg-primary group-hover:text-white transition-colors">12</span>
                            </a>
                        </li>
                        <li>
                            <a class="flex justify-between items-center text-gray-600 text-gray-300 hover:text-primary hover:text-primary transition-colors group"
                                ...
                                <span>Kesiswaan</span>
                                <span
                                    class="bg-gray-200 bg-gray-700 text-gray-600 text-gray-400 text-xs px-2 py-1 rounded-full group-hover:bg-primary group-hover:text-white transition-colors">8</span>
                            </a>
                        </li>
                        <li>
                            <a class="flex justify-between items-center text-gray-600 text-gray-300 hover:text-primary hover:text-primary transition-colors group"
                                ...
                                <span>Prestasi</span>
                                <span
                                    class="bg-gray-200 bg-gray-700 text-gray-600 text-gray-400 text-xs px-2 py-1 rounded-full group-hover:bg-primary group-hover:text-white transition-colors">5</span>
                            </a>
                        </li>
                        <li>
                            <a class="flex justify-between items-center text-gray-600 text-gray-300 hover:text-primary hover:text-primary transition-colors group"
                                ...
                                <span
                                    class="bg-gray-200 bg-gray-700 text-gray-600 text-gray-400 text-xs px-2 py-1 rounded-full group-hover:bg-primary group-hover:text-white transition-colors">10</span>
                            </a>
                        </li>
                        <li>
                            <a class="flex justify-between items-center text-gray-600 text-gray-300 hover:text-primary hover:text-primary transition-colors group"
                                ...
                                <span
                                    class="bg-gray-200 bg-gray-700 text-gray-600 text-gray-400 text-xs px-2 py-1 rounded-full group-hover:bg-primary group-hover:text-white transition-colors">24</span>
                            </a>
                        </li>
                    </ul>
                </div>
                <div
                    ...
                    <ul class="space-y-4">
                        <li class="pb-3 border-b border-gray-200 border-gray-700 last:border-0 last:pb-0">
                            <a class="group block" href="#">
                                <h4
                                    class="text-sm font-semibold text-gray-800 text-gray-200 group-hover:text-primary transition-colors mb-1">
                                    Penerimaan Peserta Didik Baru (PPDB) Tahun 2024
                                </h4>
                                <div class="text-xs text-gray-500 text-gray-400 flex items-center gap-1">
