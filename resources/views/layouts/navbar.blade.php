...
<body
    ...
    <header
        class="w-full bg-surface-light dark:bg-surface-dark border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div class="container mx-auto px-4 py-4 md:py-6 flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="flex items-center gap-4 w-full md:w-auto justify-center md:justify-start group">
                <div
                    class="w-12 h-12 md:w-16 md:h-16 flex-shrink-0 transform transition-all duration-300 group-hover:scale-105">
                    <img alt="Logo SMK Negeri 1 Kawali"
                        class="w-full h-full object-contain filter drop-shadow-sm rounded-lg"
                        src="{{ asset('beranda/logo smkn.png') }}" alt="Logo SMK">
                </div>
                <span
                    class="text-xl md:text-2xl font-semibold tracking-tight text-gray-800 dark:text-white transition-colors duration-300 group-hover:text-blue-600 dark:group-hover:text-blue-400">
                    SMK Negeri 1 Kawali
                </span>
            </div>
            <div class="flex flex-col md:flex-row items-center gap-6 md:gap-8 text-sm">
                <div class="flex items-center gap-6">
                    <div class="flex items-center gap-2 group cursor-pointer">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span
                                class="font-medium text-gray-900 dark:text-gray-200 transition-colors duration-300 group-hover:text-blue-600 dark:group-hover:text-blue-400">(0265)
                                791727</span>
                        </div>
                    </div>
                    <div class="flex items-center gap-2 group cursor-pointer">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span
                                class="font-medium text-gray-900 dark:text-gray-200 transition-colors duration-300 group-hover:text-blue-600 dark:group-hover:text-blue-400">smkn1kawali@gmail.com</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4 text-xl text-black dark:text-white">
                    <a class="hover:text-green-500 transition-all duration-300 transform hover:scale-125" href="#"><i
                            class="fa-brands fa-whatsapp"></i></a>
                    <a class="hover:text-blue-600 transition-all duration-300 transform hover:scale-125"
                        href="https://www.facebook.com/smkn1kawali/"><i class="fa-brands fa-facebook"></i></a>
                    <a class="hover:text-sky-500 transition-all duration-300 transform hover:scale-125"
                        href="https://x.com/smkn1kawali"><i class="fa-brands fa-twitter"></i></a>
                    <a class="hover:text-pink-600 transition-all duration-300 transform hover:scale-125"
                        href="https://www.instagram.com/smkn1kawali?igsh=cmFqdTU5dnZiZ2xh"><i
                            class="fa-brands fa-instagram"></i></a>
                    <a class="hover:text-red-600 transition-all duration-300 transform hover:scale-125"
                        href="https://youtube.com/@smkn1kawaliofficial?si=YUPbrK5HkNwOpZW9"><i
                            class="fa-brands fa-youtube"></i></a>
                    <a class="hover:text-black dark:hover:text-white transition-all duration-300 transform hover:scale-125"
                        href="https://www.tiktok.com/@smkn1kawali?_r=1&_t=ZS-934643ZQHv0"><i
        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-center h-16 relative">
                ...
                <button id="mobile-menu-button"
                    class="md:hidden absolute left-4 p-2 rounded-md text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none transition-all duration-300">
                    <i id="menu-icon" class="fa-solid fa-bars text-xl transition-all duration-300 ease-in-out"></i>
                </button>

                <!-- Desktop navigation -->
                <div id="desktop-menu"
                    class="hidden md:flex items-center space-x-1 text-sm font-medium text-gray-700 dark:text-gray-300">
                    ...
                    <div class="relative group desktop-dropdown">
                        ...
                        <div class="absolute left-0 mt-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg
                               opacity-0 invisible scale-95 -translate-y-2
                               group-hover:opacity-100 group-hover:visible group-hover:scale-100 group-hover:translate-y-0
                               transition-all duration-300 ease-out z-50"
